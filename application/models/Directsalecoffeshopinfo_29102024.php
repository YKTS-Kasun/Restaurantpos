<?php
class Directsalecoffeshopinfo extends CI_Model{
    ...
    {
        $html = '';
        $sql = "SELECT `idtbl_invoice`, `invdate`, `grosstotal`, `discount`, `nettotal` FROM `tbl_invoice` WHERE `orderid`=0 AND `tableid`!=0 AND `paymentcomplete`=0";
        $respond = $this->db->query($sql, array(1,0));
