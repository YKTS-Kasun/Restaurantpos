...
class Supplierpaymentinfo extends CI_Model{
    ...
    public function Paymentinsertupdate()
    {
        ...
        foreach ($tblPayData as $rowtabledata) {
            ...
            } elseif (isset($rowtabledata['col_1'])) {
                $Chequenum = isset($rowtabledata['col_4']) && !empty($rowtabledata['col_4']) ? $rowtabledata['col_4'] : '0';
                $Chequedate = isset($rowtabledata['col_5']) && !empty($rowtabledata['col_5']) ? $rowtabledata['col_5'] : '0';
                $Bank = isset($rowtabledata['col_6']) && !empty($rowtabledata['col_6']) ? $rowtabledata['col_6'] : '0';
