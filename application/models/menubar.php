...
else if($functionmenu=='Productwise'){
...
else if($functionmenu=='Tablewise'){
...
else if($functionmenu=='Dailykitchen'){
...
else if($functionmenu=='Dailyissue'){
...
else if($functionmenu=='Todaysales'){
...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <a class="nav-link p-0 px-3 py-2 text-dark" href="<?php echo base_url().'Supplierpayment'; ?>">
            ...
            <div class="collapse <?php if($controllermenu=="rptgrn" | $controllermenu=="rptstock" | $controllermenu=="rptproductwise" | $controllermenu=="rpttablewise" | $controllermenu=="rptcashsale" | $controllermenu=="rptdailykitchen" | $controllermenu=="rptdailyissue"  | $controllermenu=="rptrol" | $controllermenu=="rpttobepay" | $controllermenu=="rpttodaysales" ){echo 'show';} ?>" id="collapsereport" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'rpttobepay'; ?>">To Be Pay Report</a>
