                            ...
                            <div class="col-12">
                                <form id="searchReport">
                                    ...
                                    <div class="col-3">
                                            ...
                                            <select class="form-control form-control-sm" name="invtype" id="invtype" required>
                                                <option value="">Select</option>
                                                <?php foreach ($type->result() as $row) { ?>
                                                    <option value="<?php echo $row->idtbl_invoice ?>"><?php echo $row->invtype ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="col-2">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <select class="form-control form-control-sm" name="report_type"
                                                    ...
                                                    <option value="5">All Cash Sale</option>
                                                </select>
                                            </div>
                                        </div>
    ...
    $(document).ready(function () {
        ...
        $("#searchReport").submit(function (event) {
            ...
            $('#cashsaleTable').DataTable({
                ...
                "serverSide": true,
                ajax: {
                    url: "scripts/rptcashsalelist.php",
