        ...
        $('#dataTable').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function(data, type, full) {
                        if(full['acceptstatus']==null){return '<span class="text-danger"><i class="fas fa-times mr-2"></i>Please Accept</span>';}
                        else if(full['processstatus']==null){return '<span class="text-danger"><i class="fas fa-exchange-alt mr-2"></i>Please transfer to kitchen</span>';}
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function(data, type, full) {
                        if(full['paystatus']==1){return '<span class="text-success"><i class="fas fa-check-circle mr-2"></i>Order Complete</span>';}
                        else{return '';}
                    }
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        if(full['idtbl_res_kot']==null && full['acceptstatus']==1){
                        ...
                        if(full['paystatus']==0 && full['acceptstatus']==1){
