    	...
    	$('#btnformsearch').click(function () {
    		if (!$("#searchReport")[0].checkValidity()) {
    			...
    			$('#cashsaleTable').DataTable({
    				...
    				"serverSide": true,
    				ajax: {
    					url: "scripts/rptsalesummery.php",
    				...
    				"columns": [{
    					...
    					},
    					{
    						...
    						"render": function (data, type, full) {
    							if (full['cashtotal'] == null) {
    								return '0.00';
    							} else {
    								return addCommas(parseFloat(full['cashtotal']).toFixed(2));
    							}
    						}
    					},
    					{
    						...
    						"data": null,
    						"render": function (data, type, full) {
    							if (full['credittotal'] == null) {
    								return '0.00';
    							} else {
    								return addCommas(parseFloat(full['credittotal']).toFixed(2));
    							}
    						}
    					},
    					{
    						...
    						"data": null,
    						"render": function (data, type, full) {
    							if (full['ubertotal'] == null) {
    								return '0.00';
    							} else {
    								return addCommas(parseFloat(full['ubertotal']).toFixed(2));
    							}
    						}
    					},
    					{
    						...
    						"data": null,
    						"render": function (data, type, full) {
    							if (full['pickmetotal'] == null) {
    								return '0.00';
    							} else {
    								return addCommas(parseFloat(full['pickmetotal']).toFixed(2));
    							}
    						}
    					},
    					{
    						...
    						"data": null,
    						"render": function (data, type, full) {
    							if (full['freetotal'] == null) {
    								return '0.00';
    							} else {
    								return addCommas(parseFloat(full['freetotal']).toFixed(2));
    							}
    						}
    					},
    					{
    						...
    						"data": null,
    						"render": function (data, type, full) {
    							if (full['totalsum'] == null) {
    								return '0.00';
    							} else {
    								return addCommas(parseFloat(full['totalsum']).toFixed(2));
    							}
    						}
    					}
    				],
