...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <?php } if(menucheck($menuprivilegearray, 31)==1 | menucheck($menuprivilegearray, 32)==1){ ?>
            ...
            <div class="collapse <?php if($controllermenu=="Waiterorder" | $controllermenu=="Vieworder" ){echo 'show';} ?>" id="collapsewaiter" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
            ...
            <?php } ?>
            <?php if(menucheck($menuprivilegearray, 16)==1 | menucheck($menuprivilegearray, 33)==1){ ?>
            ...
            <div class="collapse <?php if($controllermenu=="Directsale" | $controllermenu=="Invoiceview" ){echo 'show';} ?>" id="collapseinvoice" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
