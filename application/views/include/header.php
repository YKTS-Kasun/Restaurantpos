...
<html lang="en">
    <head>
        ...
        <title> CROWN Restaurant - By Erav Technology</title>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/jqbtk.css">
        <style>
            .table tr {
                cursor: pointer;
            }
    ...
    <body class="nav-fixed <?php if($functiondirectsale=='Directsale' | $functiondirectsale=='Waiterorder' | $functiondirectsale=='Directsalecoffeshop' | $functiondirectsale=='Waitorordercoffeeshop'){echo 'sidenav-toggled';} ?>">