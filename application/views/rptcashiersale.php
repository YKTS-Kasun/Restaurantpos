                            ...
                            <div class="col-12">
                                <form id="searchReport">
                                    <div class="form-row">
                                        ...
                                        <div class="col-2">
                                            <label class="small font-weight-bold text-dark">Cashier</label>
                                            <select class="form-control form-control-sm" name="cashier" id="cashier">
                                                <option value="">Select</option>
                                                <?php foreach($cashier->result() as $cashierlist){ ?>
                                                <option value="<?php echo $cashierlist->idtbl_res_user ?>"><?php echo $cashierlist->name ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
        ...
        $('#cashier').change(function(){
            if (!$("#searchReport")[0].checkValidity()) {
                ...
                $('#cashsaleTable').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                        url: "scripts/rptcashiersale.php",
