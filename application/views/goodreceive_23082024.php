                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        if(full['approvestatus']==1){
                            ...
                            button+='<a href="<?php echo base_url() ?>Goodreceive/Goodreceivestatus/'+full['idtbl_grn']+'/1" onclick="return active_confirm()" target="_self" class="btn btn-danger btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-times"></i></a>';
                        }
