                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <h1 class="page-header-title">
                                    ...
                                    <span>Table Wise Sales Report</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-row">
                                        <div class="col-3">
                                            <label class="small font-weight-bold text-dark">Table</label>
                                            <select class="form-control form-control-sm" name="table" id="table" required>
                                                <option value="">Select</option>
                                                <?php foreach ($table->result() as $row) { ?>
                                                    <option value="<?php echo $row->idtbl_res_reservation_table  ?>"><?php echo $row->table ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="col-3">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <select class="form-control form-control-sm" name="report_type"
                                                    ...
                                                    <option value="5">All Tablewise Sales</option>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="scrollbar pb-3" id="style-2">
                                    <table class="table table-striped table-bordered table-sm nowrap" id="tablewiseTable"
                                    	style="width:100%">
                                    	<thead>
                                    		<tr>
                                    			<th>#</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#searchReport").submit(function (event) {
            ...
            $('#tablewiseTable').DataTable({
                "destroy": true,
                "processing": true,
                "serverSide": true,
                ajax: {
                    url: "scripts/rpttablewiselist.php",
                ...
                buttons: [
                    {
                        ...
                        filename: 'Tablewise Sales Report' + today,
                        text: '<i class="fas fa-file-csv mr-2"></i> CSV',
                        footer: true,
                        title: 'Gryffindor Restaurant',
                        messageTop: 'Tablewise Sales Report'
                    },
                    {
                        extend: 'excel',
