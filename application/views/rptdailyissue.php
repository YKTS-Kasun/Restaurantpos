                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <h1 class="page-header-title">
                                    ...
                                    <span>Daily Issue Stock Report</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                                        ...
                                        <div class="col-2">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <select class="form-control form-control-sm" name="report_type"
                                                    ...
                                                    <option value="5">All Daily Issue Stock</option>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="scrollbar pb-3" id="style-2">
                                    <table class="table table-striped table-bordered table-sm nowrap" id="dailyissueTable"
                                    	style="width:100%">
                                    	<thead>
                                    		<tr>
                                    			<th>#</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#searchReport").submit(function (event) {
            ...
            $('#dailyissueTable').DataTable({
                "destroy": true,
                "processing": true,
                "serverSide": true,
                ajax: {
                    url: "scripts/rptdailyissuelist.php",
                ...
                buttons: [
                    {
                        ...
                        filename: 'Daily Issue Stock Report' + today,
                        text: '<i class="fas fa-file-csv mr-2"></i> CSV',
                        footer: true,
                        title: 'Gryffindor Restaurant',
                        messageTop: 'Daily Issue Stock Report'
                    },
                    {
                        extend: 'excel',
