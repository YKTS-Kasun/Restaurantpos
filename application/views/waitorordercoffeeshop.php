					...
					<div class="card-body">
						<div class="row">
									...
									<div class="card shadow-none border-0">
										<div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
											...
											<div class="card-body border rounded"
												style="height: 700px; overflow-y:auto; background-color:#FAF7DB;"
												id="style-2">
								...
								<div class="accordion" id="accordionExample">
									<div class="card shadow-none border-0">
										<div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
											...
											<div class="card-body border rounded" style="height: 615px; overflow-y:auto;" id="style-2">
												<div id="itemlist"></div>
											</div>
										</div>
									</div>
							...
							<div class="col-sm-12 col-md-12 col-lg-5 col-xl-5">
								...
								<div id="style-17" style="height: 550px; overflow-y:auto;">
...
$(document).ready(function () {
	...
	$(document).on("click", ".itemdiv", function (e) {
		...
		$.ajax({
			...
			url: "<?php echo base_url() ?>Waitorordercoffeeshop/Getproductdetails",
     ...
     $(document).ready(function () {
     			...
     			$("#orderbtn").on('click', function (e) {
     				...
     				$.ajax({
     					...
     					url: '<?php echo base_url() ?>Waitorordercoffeeshop/Getonlineorders',
     					success: function (result) {
     			...
     			$('.categorydiv').click(function () {
     				...
     				$.ajax({
     					...
     					url: '<?php echo base_url() ?>Waitorordercoffeeshop/Getproductlist',
     					success: function (result) {
        ...
        $("#barcode").keypress(function (event) {
            if (event.keyCode === 13) { // check if the pressed key is enter key
                ...
                $.ajax({
                    ...
                    url: '<?php echo base_url() ?>Waitorordercoffeeshop/Getproductlistaccobarcode',
                    success: function (result) {
			...
			if (!$("#formqtyadd")[0].checkValidity()) {
				...
				if (tableID !== '') {
					$.ajax({
						...
						url: '<?php echo base_url() ?>Waitorordercoffeeshop/Waitorordercoffeeshopinsertupdate',
						success: function (result) {
		...
		$('.tablecatdiv').on('click', function () {
			...
			$.ajax({
				url: '<?php echo base_url('Waiterordercoffeeshop/getTablesByCategory'); ?>',
				type: 'POST',
				data: {
		...
		$(document).on('click', '.tablediv', function () {
			...
			$.ajax({
				...
				url: '<?php echo base_url() ?>Waiterordercoffeeshop/Getaddeditems',
				success: function (result) {
		...
		$('#confirmReject').click(function () {
			...
			$.ajax({
				type: "POST",
				url: '<?php echo base_url() ?>Waitorordercoffeeshop/RemoveProduct',
				data: {
					productID: productID,
					tableID: tableID,
					orderID: orderID,
	...
	// 		// 		tableID: tableID
    //         //     },
    //         //     url: '<?php echo base_url() ?>Waitorordercoffeeshop/Removeitem',
    //         //     success: function (result) { //alert(result);
    //         //     }
    //         // });
    // }
