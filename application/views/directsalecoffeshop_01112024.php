...
$(document).ready(function () {
    ...
    $('#approveDiscount').on('click', function () {
    	...
    	if (username && password) {
    		...
    		$.ajax({
    			url: '<?php echo base_url() ?>Directsalecoffeshop/validateUserAndApproveDiscount',
    			type: 'POST',
    			data: {
    				username: username,
    				password: password,
...
$(document).ready(function () {
	...
	$(document).on("click", ".itemdiv", function (e) {
		...
		$.ajax({
			...
			url: "<?php echo base_url() ?>Directsalecoffeshop/Getproductdetails",
     ...
     $(document).ready(function () {
     			...
     			$("#orderbtn").on('click', function (e) {
     				...
     				$.ajax({
     					...
     					url: '<?php echo base_url() ?>Directsalecoffeshop/Getonlineorders',
     					success: function (result) {
				 ...
				 $("#tablepaymentbtn").on('click', function (e) {
     				...
     				$.ajax({
     					...
     					url: '<?php echo base_url() ?>Directsalecoffeshop/Gettablepayments',
     					success: function (result) {
     			...
     			$('.categorydiv').click(function () {
     				...
     				$.ajax({
     					...
     					url: '<?php echo base_url() ?>Directsalecoffeshop/Getproductlist',
     					success: function (result) {
        ...
        $("#barcode").keypress(function (event) {
            if (event.keyCode === 13) { // check if the pressed key is enter key
                ...
                $.ajax({
                    ...
                    url: '<?php echo base_url() ?>Directsalecoffeshop/Getproductlistaccobarcode',
                    success: function (result) {
		...
		$('.tablecatdiv').on('click', function () {
			...
			$.ajax({
				url: '<?php echo base_url('Directsalecoffeshop/getTablesByCategory'); ?>',
				type: 'POST',
				data: {
    ...
    function createinvoice(){
        ...
        if(paystatus==1){
            $.ajax({
                ...
                url: '<?php echo base_url() ?>Directsalecoffeshop/Directsalecoffeshopinsertupdate',
                success: function (result) { //alert(result);
                    // console.log(result);
	...
	function addpayments(){
		...
		var approvestatus = $('#tableapprovestatus').val();
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>Directsalecoffeshop/Directsalecoffeshopaddpayment',
                success: function (result) { //alert(result);
                    // console.log(result);
                    var objfirst = JSON.parse(result);
                    if(objfirst.actiontype==1){
    ...
    function posprintbill(invoiceid){
        window.open('<?php echo base_url() ?>Directsalecoffeshop/Getposprintbill/'+invoiceid, "_blank");
