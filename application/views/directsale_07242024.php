										...
										<div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
												...
												<div class="row">
													...
													<div class="col">
														<button type="button" id="orderbtn"
															...
															<?php if($addcheck==0){echo 'disabled';} ?>><i class="fas fa-globe"></i></i>&nbsp;ONLINE ORDERS</button>
													</div>
												</div>
											</div>
											<div class="card-body border rounded" style="height: 460px; overflow-y:auto;" id="style-2">
												...
												<div style="display: flex; justify-content: center; align-items: center; margin-top:30px;">
													<img id="restaurant-image" src="<?php echo base_url('images/logo.jpg') ?>" alt=""
        			...
        			$.ajax({
        				...
        				success: function (result) {
							...
							var formatter = new Intl.NumberFormat('en-US', {
								...
								var formattedTotal = formatter.format(item.totalamount);
								var formattedDiscount = formatter.format(item.discountamount);
								var formattedNetTotal = formatter.format(item.totalwithdis);

							$('#labeltotal').html('Gross Amount: ' + formattedTotal);
							$('#labeldistotal').html('Discount: ' + formattedDiscount);
							$('#labelnettotal').html(formattedNetTotal);
